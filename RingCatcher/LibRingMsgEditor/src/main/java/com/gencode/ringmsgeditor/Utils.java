...
public class Utils {
    ...
    public static void showWarningDialog(Context context, int titleId, int messageId) {
        showWarningDialog(context, context.getResources().getString(titleId), context.getResources().getString(messageId));
    }
