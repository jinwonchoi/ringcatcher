...
public class GencodeGcmListenerService extends GcmListenerService {
    ...
    private void sendNotification(String message) {
        ...
        try {
            ...
            if (Locale.KOREA.toString().equals(jsonRootObject.optString(JsonConstants.locale))) {
                ...
                displayMsg = String.format("%s(%s) wants you to change his/her ringtone.", jsonRootObject.optString(JsonConstants.callerName),jsonRootObject.optString(JsonConstants.callerNum));
                title = "Find out your ringcatcher's updates.";
            }

            String packageName = this.getPackageName();
            Intent intent = this.getPackageManager().getLaunchIntentForPackage(packageName);
            intent.putExtra(JsonConstants.callerNum,jsonRootObject.optString(JsonConstants.callerName));
            intent.putExtra(JsonConstants.callerName,jsonRootObject.optString(JsonConstants.callerName));
