...
public class AsyncInviteMate extends AsyncTask<String, Void, InviteResult> {
    ...
    protected InviteResult doInBackground(String... args) {
        ...
        inviteUploadRequest.setCallingPhoneNum(args[1]/*"0244445555"*/);
        inviteUploadRequest.setCallingNickName(args[2]/*"It's me!"*/);
        inviteUploadRequest.setLocale(args[3]);//Locale.KOREA.toString()); //ko_KR | en_US
